...
>(({ asChild = false, isActive = false, tooltip, className, ...props }, ref) => {
  ...
  const button = (
    <Comp
      ...
      className={cn(
        "peer/menu-action flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-none ring-sidebar-ring transition-all hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "peer-hover/menu-action:text-sidebar-accent-foreground peer-data-[active=true]/menu-action:text-sidebar-accent-foreground",
        "peer-focus-visible/menu-action:text-sidebar-accent-foreground",
        "group-data-[collapsible=icon]:hidden",
        className
      )}
      {...props}
